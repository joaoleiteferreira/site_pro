...
<!-- Structure Begin -->
		<div class="wrapper">
			<div class="grid_24"><h2>Sandbox Performance Submit</h2>
...
//         require $KoolControlsFolder."../../KoolCalendar/koolcalendar.php";
	...
	$ds->SelectCommand = "select ID,TOPOLOGY,MODEL,XML_FILE,TIME_ADDED,NOTES,RUN_PARAMETERS from tests WHERE CLASS='SANDBOX' order by XML_FILE asc";
...
list($user, $password) = split("@", $screen_res);
echo "<h5>This is your TaaS username and password</h5><h6> Username:$user <br>Password:$password";
?>
...
if($_POST['Reset']) {
    ...
    , 'var username = prompt("Please enter your TaaS username", "");'
    , 'var password = prompt("Please enter your TaaS(No CEC) password", "");'
    , 'var the_cookie_date = the_date.toGMTString();'
    , 'var the_cookie = "user_password="+ username +"@"+ password;'
    , 'var the_cookie = the_cookie + ";expires=" + the_cookie_date;'
    , 'document.cookie=the_cookie;'
    ...
    echo '<script type="text/javascript">'
   , 'window.open("http://joao-lnx/site_pro/sandbox_submit.php","_self");'
   , '</script>';
