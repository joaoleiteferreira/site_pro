...
<!-- Structure Begin -->
		<div class="wrapper">
			<div class="grid_24"><h2>Performance Results</h2>
...
//         require $KoolControlsFolder."../../KoolCalendar/koolcalendar.php";
	...
	$ds->SelectCommand = "select ID,RESULT,MODEL,RUN_PARAMETERS,SUBMITTER,BANDWIDTH,XML_FILE,TIME_FINISH,DURATION,NOTES,TRAFFIC,CONFIG,VERSION,LIMIT_FACTOR,LOG,STATS from resuts_performance WHERE CLASS='PERFORMANCE' order by TIME_FINISH desc";
