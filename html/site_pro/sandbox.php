...
if (file_exists($filename)) {
    $filename2 = $var = $_GET['XML'];
    $filename2 = "XML/$filename2";
    if($filename2 == $filename) {
    echo '<script type="text/javascript">'
    , 'alert("You provided the same name, we will just modify the original file");'
    , '</script>';
    ...
    sleep(2);
    echo '<script type="text/javascript">'
   , 'window.open("http://joao-lnx/site_pro/sandbox.php","_self");'
   , '</script>';
    } else {
    echo '<script type="text/javascript">'
    , 'alert("This file already exists as a different test. Please use diferent name");'
    , '</script>';
   }
} else {
    echo '<script type="text/javascript">'
...
<script type="text/javascript">
		...
		var test2 = "http://192.168.56.101/site_pro/sandbox.php?XML=";
		var test = test2 + test;
