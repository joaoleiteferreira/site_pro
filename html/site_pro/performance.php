...
//         require $KoolControlsFolder."../../KoolCalendar/koolcalendar.php";
	...
	$ds->SelectCommand = "select ID,TOPOLOGY,MODEL,XML_FILE,TIME_ADDED,NOTES,TRAFFIC,CONFIG from tests WHERE CLASS='PERFORMANCE' order by XML_FILE asc";
...
<!-- Full-width Begin -->
		<div class="wrapper"><div class="grid_24">
		  <form action="/site_pro/performance.php" method="POST"> 
...
if (file_exists($filename)) {
    ...
    sleep(15);
    echo '<script type="text/javascript">'
   , 'window.open("http://192.168.56.101/site_pro/performance.php","_self");'
   , '</script>';
/*
    $xml = new XMLReader();
...
<script type="text/javascript">
		...
		var test2 = "http://192.168.56.101/site_pro/performance.php?XML=";
		var test = test2 + test;
