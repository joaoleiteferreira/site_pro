...
function graph(MODEL,VERSION) {
  jQuery(document).ready(function() {
	...
	var lineNo;
        var options;
    graph_title = MODEL + " version:" + VERSION;
    var options = {
      chart: {
              type: 'column',
        renderTo: 'container2',
	...
	var array_data =[];
	file2 = "/site_pro/mysql_query/by_platform.php?MODEL=" + MODEL + "&VERSION=" + VERSION;
...
<!-- Structure Begin -->
		<div class="wrapper">
			<div class="grid_24"><h2>Analyse Sandbox performance on specific Platform</h2>
...
//         require $KoolControlsFolder."../../KoolCalendar/koolcalendar.php";
	...
	$ds->SelectCommand = "SELECT VERSION,MODEL,count(DISTINCT CONFIG) as HITS,TRAFFIC FROM resuts_performance WHERE RESULT='PASS' and CLASS='SANDBOX' GROUP BY VERSION,TRAFFIC,MODEL order by HITS desc";
...
// 	$grid->MasterTable->AddColumn($col);
	...
	$column = new GridBoundColumn();
	$column->HeaderText = "Number of configs run";
	...
	$column->OnClick = "graph(\"{MODEL}\",\"{VERSION}\")";
