...
//         require $KoolControlsFolder."../../KoolCalendar/koolcalendar.php";
	...
	$ds->SelectCommand = "SELECT VERSION,MODEL,count(DISTINCT CONFIG) as HITS,TRAFFIC FROM resuts_performance WHERE RESULT='PASS' GROUP BY VERSION,TRAFFIC,MODEL order by HITS desc";
