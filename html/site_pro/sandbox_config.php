...
//         require $KoolControlsFolder."../../KoolCalendar/koolcalendar.php";
	...
	$ds->SelectCommand = "SELECT CONFIG,VERSION,count(DISTINCT MODEL) as HITS,TRAFFIC FROM resuts_performance WHERE RESULT='PASS' and CLASS='SANDBOX' GROUP BY VERSION,TRAFFIC,CONFIG order by HITS desc";
